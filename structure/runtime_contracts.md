...
| --- | --- | --- | --- |
| ChatGPT | render, session store, fixture eval, model alias contract | live send/poll/query/upload/copy | composer/send/upload resolver validation, model evidence 미확인 |
