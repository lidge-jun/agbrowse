...
| `skills/browser/` | 55 | 16417 | Chrome lifecycle, CDP connection, refs, tabs, diagnostics, adaptive fetch v2, search orchestrator, Runway task-runner preflight/poll |
...
| `test/integration/` | 24 | 4074 | CLI, MCP, policy, provider fixture tests |
...
| `devlog/` | 568 | 82084 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| 파일 | 라인 수 | 설명 |
| --- | ---: | --- |
| `skills/browser/browser.mjs` | 3633 | root CLI parser, Chrome lifecycle, browser primitive commands |
