...
| `web-ai/` | 119 | 31695 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 158 | 25091 | deterministic module tests |
...
| `devlog/` | 611 | 91211 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/chatgpt.mjs` | 1886 | ChatGPT provider send/poll/query/status with streaming-safe recovery gates |
| `web-ai/chatgpt-response-dom.mjs` | 545 | shared ChatGPT assistant DOM extraction plus the Node-side composer-scoped stop probe |
