...
| `web-ai/` | 117 | 29867 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 147 | 19810 | deterministic module tests |
...
| `devlog/` | 547 | 75083 | phased plan, research, implementation notes (incl. strict-migration phases) |
