...
| `web-ai/` | 119 | 30986 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/integration/` | 24 | 4337 | CLI, MCP, policy, provider fixture tests |
...
| `devlog/` | 572 | 82736 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/cli.mjs` | 2121 | `web-ai` subcommand parser and command orchestration |
