...
| `skills/web-ai/` | 3 | 908 | bundled agent workflow skill |
| `web-ai/` | 115 | 29227 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 144 | 18999 | deterministic module tests |
...
| `devlog/` | 532 | 72237 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/cli.mjs` | 2078 | `web-ai` subcommand parser and command orchestration |
...
| `web-ai/chatgpt.mjs` | 1383 | ChatGPT provider send/poll/query/status with streaming-safe recovery gates |
