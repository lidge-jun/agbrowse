...
| `web-ai/` | 119 | 32785 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 158 | 26529 | deterministic module tests |
...
| `web-ai/mcp-server.mjs` | 488 | stdio JSON-RPC MCP bridge |
