...
| `skills/web-ai/` | 3 | 883 | bundled agent workflow skill |
| `web-ai/` | 114 | 27679 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 142 | 18132 | deterministic module tests |
| `test/integration/` | 21 | 3305 | CLI, MCP, policy, provider fixture tests |
...
| `web-ai/cli.mjs` | 2025 | `web-ai` subcommand parser and command orchestration |
