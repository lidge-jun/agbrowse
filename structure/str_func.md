...
| `web-ai/` | 69 | 10784 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 53 | 5251 | deterministic module tests |
...
| `devlog/` | 61 | 13200 | phased plan, research, implementation notes |
