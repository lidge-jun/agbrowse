...
| `skills/browser/` | 23 | 6842 | Chrome lifecycle, CDP connection, refs, tabs, diagnostics |
...
| `test/unit/` | 84 | 8004 | deterministic module tests |
| `test/integration/` | 16 | 1951 | CLI, MCP, policy, provider fixture tests |
