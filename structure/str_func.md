...
| `web-ai/` | 119 | 31084 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 157 | 22884 | deterministic module tests |
| `test/integration/` | 24 | 5126 | CLI, MCP, policy, provider fixture tests |
...
| `devlog/` | 604 | 88506 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/chatgpt.mjs` | 1608 | ChatGPT provider send/poll/query/status with streaming-safe recovery gates |
