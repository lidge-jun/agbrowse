...
| `web-ai/` | 119 | 31453 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 157 | 23836 | deterministic module tests |
...
| `web-ai/cli.mjs` | 2146 | `web-ai` subcommand parser and command orchestration |
