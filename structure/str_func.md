...
| `web-ai/` | 69 | 10810 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 53 | 5319 | deterministic module tests |
...
| `devlog/` | 61 | 13210 | phased plan, research, implementation notes |
