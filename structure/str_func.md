...
| `web-ai/` | 119 | 31958 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 158 | 25393 | deterministic module tests |
...
| `devlog/` | 612 | 91579 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/chatgpt.mjs` | 2134 | ChatGPT provider send/poll/query/status with streaming-safe recovery gates |
