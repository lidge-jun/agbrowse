...
| `web-ai/` | 119 | 31610 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 158 | 24906 | deterministic module tests |
...
| `devlog/` | 609 | 90530 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/chatgpt.mjs` | 1882 | ChatGPT provider send/poll/query/status with streaming-safe recovery gates |
| `web-ai/chatgpt-response-dom.mjs` | 507 | shared ChatGPT assistant DOM extraction plus the Node-side composer-scoped stop probe |
