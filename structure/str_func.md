...
| `web-ai/` | 96 | 22109 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 105 | 12457 | deterministic module tests |
...
| `devlog/` | 369 | 46108 | phased plan, research, implementation notes (incl. strict-migration phases) |
