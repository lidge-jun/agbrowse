...
| `skills/browser/` | 55 | 16379 | Chrome lifecycle, CDP connection, refs, tabs, diagnostics, adaptive fetch v2, search orchestrator, Runway task-runner preflight/poll |
...
| `web-ai/` | 119 | 30955 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 156 | 22540 | deterministic module tests |
| `test/integration/` | 24 | 4001 | CLI, MCP, policy, provider fixture tests |
...
| `devlog/` | 564 | 81241 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| 파일 | 라인 수 | 설명 |
| --- | ---: | --- |
| `skills/browser/browser.mjs` | 3595 | root CLI parser, Chrome lifecycle, browser primitive commands |
...
| `web-ai/cli.mjs` | 2096 | `web-ai` subcommand parser and command orchestration |
