...
| `web-ai/` | 119 | 32069 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 158 | 25824 | deterministic module tests |
...
| `web-ai/chatgpt.mjs` | 2164 | ChatGPT provider send/poll/query/status with streaming-safe recovery gates |
