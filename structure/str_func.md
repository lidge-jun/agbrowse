...
| `web-ai/` | 113 | 27844 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 143 | 17985 | deterministic module tests |
...
| `devlog/` | 528 | 72019 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/cli.mjs` | 2015 | `web-ai` subcommand parser and command orchestration |
...
| `web-ai/chatgpt.mjs` | 1227 | ChatGPT provider send/poll/query/status with streaming-safe recovery gates |
