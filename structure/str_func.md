...
| `web-ai/` | 120 | 33547 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 163 | 27982 | deterministic module tests |
...
| `web-ai/chatgpt.mjs` | 2242 | ChatGPT provider send/poll/query/status with streaming-safe recovery gates |
