...
| `web-ai/` | 119 | 31998 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 158 | 25490 | deterministic module tests |
...
| `devlog/` | 612 | 91696 | phased plan, research, implementation notes (incl. strict-migration phases) |
