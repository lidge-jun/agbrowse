...
| `web-ai/` | 119 | 32063 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 158 | 25790 | deterministic module tests |
...
| `devlog/` | 613 | 92350 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/chatgpt.mjs` | 2158 | ChatGPT provider send/poll/query/status with streaming-safe recovery gates |
