...
| `web-ai/` | 119 | 30859 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 155 | 22123 | deterministic module tests |
| `test/integration/` | 23 | 3866 | CLI, MCP, policy, provider fixture tests |
...
| `devlog/` | 562 | 80627 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/cli.mjs` | 2092 | `web-ai` subcommand parser and command orchestration |
...
| `web-ai/chatgpt.mjs` | 1594 | ChatGPT provider send/poll/query/status with streaming-safe recovery gates |
