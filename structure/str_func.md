...
| `skills/browser/` | 55 | 16511 | Chrome lifecycle, CDP connection, refs, tabs, diagnostics, adaptive fetch v2, search orchestrator, Runway task-runner preflight/poll |
...
| `web-ai/` | 119 | 30978 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/integration/` | 24 | 4313 | CLI, MCP, policy, provider fixture tests |
...
| `devlog/` | 569 | 82290 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `skills/browser/search.mjs` | 415 | standalone search orchestrator: query rewrite → fetch → evidence score → output |
...
| `skills/browser/adaptive-fetch/index.mjs` | 746 | adaptive fetch v2 CLI + 6-phase escalation scheduler |
...
| `web-ai/cli.mjs` | 2113 | `web-ai` subcommand parser and command orchestration |
