...
| `web-ai/` | 119 | 31487 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 157 | 24202 | deterministic module tests |
...
| `devlog/` | 606 | 89723 | phased plan, research, implementation notes (incl. strict-migration phases) |
