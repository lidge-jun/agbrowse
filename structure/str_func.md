...
| `web-ai/` | 119 | 32898 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 158 | 26700 | deterministic module tests |
...
| `devlog/` | 614 | 92576 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/cli.mjs` | 2238 | `web-ai` subcommand parser and command orchestration |
...
| `web-ai/gemini-live.mjs` | 1022 | Gemini provider send/poll/query/status |
