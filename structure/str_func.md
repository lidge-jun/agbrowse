...
| `web-ai/` | 119 | 30710 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 154 | 21852 | deterministic module tests |
| `test/integration/` | 23 | 3818 | CLI, MCP, policy, provider fixture tests |
