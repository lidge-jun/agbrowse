...
| `web-ai/` | 67 | 10272 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 49 | 4478 | deterministic module tests |
| `test/integration/` | 14 | 1420 | CLI, MCP, policy, provider fixture tests |
| `test/e2e/` | 1 | 50 | browser smoke coverage |
| `test/spec/` | 2 | 35 | high-level contract specs |
| `docs/` | 2 | 79 | adoption and trace docs |
| `devlog/` | 52 | 12846 | phased plan, research, implementation notes |
