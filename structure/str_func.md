...
| `web-ai/` | 69 | 10659 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 53 | 4873 | deterministic module tests |
| `test/integration/` | 14 | 1469 | CLI, MCP, policy, provider fixture tests |
| `test/e2e/` | 1 | 50 | browser smoke coverage |
| `test/spec/` | 2 | 35 | high-level contract specs |
| `docs/` | 2 | 79 | adoption and trace docs |
| `devlog/` | 59 | 13107 | phased plan, research, implementation notes |
...
| `web-ai/chatgpt.mjs` | 602 | ChatGPT provider send/poll/query/status |
