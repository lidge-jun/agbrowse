...
| `skills/browser/` | 41 | 12763 | Chrome lifecycle, CDP connection, refs, tabs, diagnostics, adaptive fetch v2, Runway task-runner preflight/poll |
...
| `test/unit/` | 96 | 10852 | deterministic module tests |
| `test/integration/` | 17 | 2319 | CLI, MCP, policy, provider fixture tests |
...
| `devlog/` | 332 | 41154 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| 파일 | 라인 수 | 설명 |
| --- | ---: | --- |
| `skills/browser/browser.mjs` | 3380 | root CLI parser, Chrome lifecycle, browser primitive commands |
