...
| `skills/browser/` | 55 | 16406 | Chrome lifecycle, CDP connection, refs, tabs, diagnostics, adaptive fetch v2, search orchestrator, Runway task-runner preflight/poll |
...
| `test/integration/` | 24 | 4050 | CLI, MCP, policy, provider fixture tests |
...
| `devlog/` | 566 | 81584 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| 파일 | 라인 수 | 설명 |
| --- | ---: | --- |
| `skills/browser/browser.mjs` | 3622 | root CLI parser, Chrome lifecycle, browser primitive commands |
