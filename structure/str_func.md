...
| `web-ai/` | 119 | 32072 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 158 | 25871 | deterministic module tests |
...
| `web-ai/chatgpt.mjs` | 2167 | ChatGPT provider send/poll/query/status with streaming-safe recovery gates |
