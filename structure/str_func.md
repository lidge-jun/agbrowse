...
| `skills/web-ai/` | 3 | 929 | bundled agent workflow skill |
| `web-ai/` | 122 | 34899 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 175 | 29868 | deterministic module tests |
