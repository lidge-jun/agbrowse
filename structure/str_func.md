...
| `web-ai/` | 119 | 31876 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 158 | 25268 | deterministic module tests |
...
| `devlog/` | 612 | 91368 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/chatgpt.mjs` | 2052 | ChatGPT provider send/poll/query/status with streaming-safe recovery gates |
