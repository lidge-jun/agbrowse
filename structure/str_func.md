...
| `web-ai/` | 69 | 10680 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 53 | 4889 | deterministic module tests |
...
| `devlog/` | 60 | 13145 | phased plan, research, implementation notes |
