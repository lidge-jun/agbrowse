...
| `web-ai/` | 69 | 10814 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 53 | 5344 | deterministic module tests |
...
| `devlog/` | 61 | 13212 | phased plan, research, implementation notes |
