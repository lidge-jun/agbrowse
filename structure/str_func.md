...
| `web-ai/` | 69 | 10819 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 53 | 5362 | deterministic module tests |
...
| `devlog/` | 61 | 13214 | phased plan, research, implementation notes |
