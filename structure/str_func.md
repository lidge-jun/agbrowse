...
| `web-ai/` | 69 | 10792 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 53 | 5270 | deterministic module tests |
...
| `devlog/` | 61 | 13203 | phased plan, research, implementation notes |
