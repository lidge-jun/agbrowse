...
| `web-ai/` | 69 | 10610 | provider automation, sessions, MCP, eval, policy, trace |
...
| `devlog/` | 58 | 13064 | phased plan, research, implementation notes |
...
| `web-ai/chatgpt.mjs` | 553 | ChatGPT provider send/poll/query/status |
