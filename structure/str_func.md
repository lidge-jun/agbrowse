...
| `web-ai/` | 117 | 29900 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 147 | 19915 | deterministic module tests |
...
| `devlog/` | 552 | 77650 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/chatgpt-response-dom.mjs` | 227 | shared ChatGPT top-level assistant DOM extraction helpers |
