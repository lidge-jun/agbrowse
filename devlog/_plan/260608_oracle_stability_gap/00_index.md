...
| 32 deep research/session | 🟡 32.1·32.3 ✅ / 32.2 impl-ready | 32.1 DR target-scope(83e4712) + 32.3 session guard(335cd2d) **구현완료**; 32.2 model picker 남음 |
...
**구현 시퀀스 ([36](36_implementation_master_plan.md) §3, 실행 중)**: ✅31(P0 generic files) → ✅32.1(P0 DR capture) → ✅32.3(P1 session guard) → 32.2(P1 model picker) → **35**(P1 new-tab/DR reattach) → **33**(P1 dual-path, 마지막) → **34**(P2 diagnostics). — **3/7 사이클 완료**.
