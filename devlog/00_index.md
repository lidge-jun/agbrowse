...
| web-ai 폴링 데드라인 계약 (#88) | `_plan/260731_webai_poll_deadline/` | 🔧 WP10 fail-open 교정(B03/B06) + WP12 command lock async + WP13 유입 방지 게이트(`3a48e34`~`12b0e50`). 예산 계약 WP1~WP9 미착수 — 후보 A는 G1 unmet(`withStoreLock` 87곳), G2/G4 미측정, G3 partial. |
