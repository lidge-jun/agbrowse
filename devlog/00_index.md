...
| web-ai 폴링 데드라인 계약 (#88) | `_plan/260731_webai_poll_deadline/` | 🔧 fail-open 교정 B03/B06/B01/B02/B07 + command lock async + 유입 방지 게이트(`6742949`~`d86f394`). B04는 OPEN(공유 producer). 예산 계약 미착수 — G1 unmet(`withStoreLock` 87곳), G2/G4 미측정, G3 partial. |
